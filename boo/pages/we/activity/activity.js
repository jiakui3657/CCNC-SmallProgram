...
Page({
  ...
  activityDetails: function (e) {
    console.log(e)
    wx.navigateTo({
      url: '../../../pages/we/activityDetails/activityDetails?id=' + e.currentTarget.id + '&longstate=' + e.currentTarget.dataset.longstate + '&latstate=' + e.currentTarget.dataset.latstate + '&name=' + e.currentTarget.dataset.name
    })
  },
